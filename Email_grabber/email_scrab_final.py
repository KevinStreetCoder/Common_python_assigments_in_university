...
class EmailCrawler:
    ...
    def parse_url(self, current_url: str):
        ...
        try:
            ...
            #parsing email
            self.parse_emails(response_text,current_url)
    ...
    def parse_emails(self, text: str,url):
        """
...
websites = []
for i in range(5):
    website = input("Please enter website {} link to crawl for emails:\n".format(i+1))
    while(website==""):
        website3 = input("Please enter website {} link to crawl for emails:\n".format(i+1))
        website = website3
    while(valid_url(website)==False):
        website2 = input("Please check link and re-enter website {} link to crawl for emails:\n".format(i+1))
        website = website2  

    websites.append(website)
    print ('URL is good!')
for a in range(len(websites)):
    crawl = EmailCrawler(websites[a])
    print("-----------------------------------------")
    crawl.crawl()
